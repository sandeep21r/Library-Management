...
public class BookService {
    ...
    public BooksEntity createBook(BookDataRequest bookDataRequest){
        ...
        log.info("Book is creating isbn : {}" ,bookDataRequest.getIsbn());
    ...
    public ParentBookDataResponse getBookById(UUID id){
        ...
        if("ADMIN".equalsIgnoreCase(userEntity.getRoll()) ) {
            ...
            ParentBookDataResponse bookDataResponse = new BookDataResponse(booksEntities.getId(), booksEntities.getTitle(), booksEntities.getAuthor(), booksEntities.getEdition(), booksEntities.getLanguage(), booksEntities.getPublisher(), booksEntities.getIsbn(), booksEntities.getQuantity(), bookInstanceResponseList);
